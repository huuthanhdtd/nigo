  ...
  data() {
    return {
      products: [
        ...
        {
          name: 'Nigo Sweatshirt White',
          description:
            'Unisex White Sweatshirt with The Nigo Logo embroidered.',
          img: 'sweat_white',
          url: '',
          price: 999
        },
        {
          name: 'Nigo Sweatshirt Black Heather Blue',
          description:
            'Unisex Black Heather Blue Sweatshirt with The Nigo Logo embroidered.',
          img: 'sweat_blue',
          url: '',
          price: 999
        },
        {
          ...
          description:
            '8 New Design stickers: 4 Mountains Logo Stickers and- 4 Nigo Logo Stickers.',
          img: 'new_stickers',
          url: '',
          price: 999
        },
