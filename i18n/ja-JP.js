module.exports = {
  ...
  homepage: {
    ...
    welcome: {
      ...
      description:
        'Nigo を使用し自信を持って次の Vue.js アプリケーションをビルドしましょう。ウェブ開発をシンプルかつ強力にする{openSource}フレームワークです。',
      openSource: 'オープンソース',
      get_started: 'はじめる',
  ...
  team: {
    ...
    title: '{nuxt} Team',
    description:
      'The development of Nigo and its ecosystem is guided by an international team. We have a very active and engaged team that is constantly striving to push Nuxt forward.'
  },
  themes: {
    meta: {
      title: 'Nigo Themes',
